...
#    def test_attributes(self):
    ...
    def test_str_method(self):
        ...
        expected_str_rep = f"[{self.instance.__class__.__name__}] ({self.instance.id}) {self.instance.__dict__}"
    ...
    def test_to_dict_method(self):
        ...
        # Check if the __class__ key is present and correct
        ...
        # Check if created_at is present and correctly formatted
        self.assertIn("created_at", instance_dict)
        self.assertEqual(instance_dict["created_at"], self.instance.created_at.isoformat())

        # Check if updated_at is present and correctly formatted
